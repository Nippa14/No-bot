/*
 Big Thanks To
   ᨟ king nameless (Dev)
   ᨟ king gamble (BestSupportandsepuh)
   ᨟ Size (BestSupport)
   ᨟ king  (BestSupport)
   ᨟ king noble (BestSupport)
   ᨟ king haki (BestSupport)
   ᨟ king member (BestSupport)
*/
...
`))
		...
		console.log(chalk.green(`𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝙑3 𝘾𝙍𝘼𝙎𝙃𝙀𝙍 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 : ${code} `));
...
start(`1`, `𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝙑3 Connecting...`)
} else if (connection === "open") {
success(`1`, `𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝙑3 is Connected`)
...
require("./𝙎𝘾𝘼𝙍𝙇𝙀𝙏 𝙑3.js")(bad, m, store)
} catch (err) {
console.log(err)
}
})
